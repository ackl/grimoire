/* CONFIGURATION STARTS HERE */
  ...
  const MY_DOMAIN = 'grimoire.ackl.me';
   ...
   */
  const SLUG_TO_PAGE = {
    '': '901e7eed6c2c4d99a9e10d1948447572',
  };
  
  /* Step 3: enter your page title and description for SEO purposes */
  const PAGE_TITLE = 'Book of Shadows';
  const PAGE_DESCRIPTION = 'My personal book of shadows';
...
`;
  const CUSTOM_SCRIPT_TEMPLATE = `
      const customObserver = new MutationObserver(function() {
          ${CUSTOM_SCRIPT}
      });
      customObserver.observe(document.querySelector('#notion-app'), {
        childList: true,
        subtree: true,
      });
`;
